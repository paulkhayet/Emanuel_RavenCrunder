...
public class Fergus extends NPC {
	...
	public void hangWithFergus(Player p) {
		...
		Modifier sword = new Modifier("Steel Sword", "strength has increased", 2, 0, 0, 0);
		sword.use(p);
			...
			if(option == 1) {
				...
				if(option == 1) {
					...
					System.out.println("You attack the goat and cut it into little pieces, each of which you\n" +
						"devour with the same unruly hunger for flesh. But it's not the same. Nothing is.\n" +
						...
						"tomato, pickles and their special Big Mac" + (char)169 + " sauce, you won't regret ordering one.\n" +
